    ...
    static class TestConfig {
        ...
        public KafkaTemplate<String, UserForKafkaDTO> userRegistrationKafkaTemplate() {
            return new KafkaTemplate<>(createProducerFactory(
                    "UserForKafkaDTO:com.platform.booking.recording.auth_service.dtos.UserForKafkaDTO"
            ));
        }
        ...
        public KafkaTemplate<String, ProviderUpdateEmailDTO> userEmailKafkaTemplate() {
            return new KafkaTemplate<>(createProducerFactory(
                    "ProviderUpdateEmailDTO:com.platform.booking.recording.auth_service.dtos.ProviderUpdateEmailDTO"
            ));
        }
        ...
        public KafkaTemplate<String, ProviderIsBlockedDTO> userIsBlockedKafkaTemplate() {
            return new KafkaTemplate<>(createProducerFactory(
                    "ProviderIsBlockedDTO:com.platform.booking.recording.auth_service.dtos.ProviderIsBlockedDTO"
            ));
        }
        ...
        public KafkaTemplate<String, UserAvatarForKafkaDTO> userAvatarKafkaTemplate() {
            return new KafkaTemplate<>(createProducerFactory(
                    "UserAvatarForKafkaDTO:com.platform.booking.recording.auth_service.dtos.UserAvatarForKafkaDTO"
            ));
        }
    }
    @Autowired
