...
import com.platform.booking.recording.auth_service.dtos.ProviderUpdateEmailDTO;
...
public class KafkaConfig {
    ...
    public ProducerFactory<String, UserForKafkaDTO> userRegistrationProducerFactory(){
        ...
        configKafkaProducer.put(JacksonJsonSerializer.TYPE_MAPPINGS, "UserForKafkaDTO:com.platform.booking.recording.auth_service.dtos.UserForKafkaDTO");
    ...
    public ProducerFactory<String, ResetPassword> userResetPasswordProducerFactory(){
        ...
        configKafkaProducer.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configKafkaProducer.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JacksonJsonSerializer.class);
        configKafkaProducer.put(JacksonJsonSerializer.TYPE_MAPPINGS, "ResetPassword:com.platform.booking.recording.auth_service.models.ResetPassword");
        return new DefaultKafkaProducerFactory<>(configKafkaProducer);
    }
    @Bean
    ...
    public ProducerFactory<String, ProviderUpdateEmailDTO> userEmailProducerFactory(){
        ...
        configKafkaProducer.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configKafkaProducer.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JacksonJsonSerializer.class);
        configKafkaProducer.put(JacksonJsonSerializer.TYPE_MAPPINGS, "ProviderUpdateEmailDTO:com.platform.booking.recording.auth_service.dtos.ProviderUpdateEmailDTO");
        return new DefaultKafkaProducerFactory<>(configKafkaProducer);
    }
    @Bean
    ...
    public ProducerFactory<String, UserAvatarForKafkaDTO> userAvatarProducerFactory(){
        ...
        configKafkaProducer.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configKafkaProducer.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JacksonJsonSerializer.class);
        configKafkaProducer.put(JacksonJsonSerializer.TYPE_MAPPINGS, "UserAvatarForKafkaDTO:com.platform.booking.recording.auth_service.dtos.UserAvatarForKafkaDTO");
        return new DefaultKafkaProducerFactory<>(configKafkaProducer);
    }
    @Bean
    ...
    public ProducerFactory<String, ProviderIsBlockedDTO> userIsBlockedProducerFactory(){
        ...
        configKafkaProducer.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configKafkaProducer.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JacksonJsonSerializer.class);
        configKafkaProducer.put(JacksonJsonSerializer.TYPE_MAPPINGS, "ProviderIsBlockedDTO:com.platform.booking.recording.auth_service.dtos.ProviderIsBlockedDTO");
        return new DefaultKafkaProducerFactory<>(configKafkaProducer);
    }
    @Bean
