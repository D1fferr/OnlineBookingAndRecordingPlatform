...
import com.platform.booking.recording.provider_service.dtos.KafkaDTO.AppointmentCancelledForKafkaDTO;
import com.platform.booking.recording.provider_service.dtos.KafkaDTO.AppointmentCreateForKafkaDTO;
import com.platform.booking.recording.provider_service.dtos.KafkaDTO.AppointmentForKafkaDTO;
...
class KafkaAppointmentProducerServiceIntegrationTest extends AbstractBaseKafkaTest {
    ...
    static class TestConfig {
        ...
        public KafkaTemplate<String, AppointmentForKafkaDTO> appointmentCreateKafkaTemplate() {
            return new KafkaTemplate<>(createProducerFactory(
                    "AppointmentForKafkaDTO:com.platform.booking.recording.provider_service.dtos.KafkaDTO.AppointmentForKafkaDTO"
            ));
        }
        ...
        public KafkaTemplate<String, AppointmentCancelledForKafkaDTO> appointmentCancelledKafkaTemplate() {
            return new KafkaTemplate<>(createProducerFactory(
                    "AppointmentCancelledForKafkaDTO:com.platform.booking.recording.provider_service.dtos.KafkaDTO.AppointmentCancelledForKafkaDTO"
            ));
        }
    }
    ...
    void setUp() {
        ...
        createDeserializerProps.put(JacksonJsonDeserializer.TYPE_MAPPINGS,
                "AppointmentForKafkaDTO:com.platform.booking.recording.provider_service.dtos.KafkaDTO.AppointmentCreateForKafkaDTO");
